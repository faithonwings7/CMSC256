...
public class MyGraphTest<V> extends UnweightedGraph<V> {
    ...
    public MyGraphTest(V[] vertices, int[][] edges){
        super(vertices, edges);
    }

    /** Constructor: a graph from vertices and edges stored in List */
    public MyGraphTest(List<V> vertices, List<Edge> edges){
        super(vertices, edges);
        this.vertices = vertices;
    }

    /** Constructor: a graph for integer vertices 0, 1, 2 and edge list */
    public MyGraphTest(List<Edge> edges, int numberOfVertices){
        super(edges, numberOfVertices);
    }

    /** Constructor: a graph from integer vertices 0, 1, and edge array */
    public MyGraphTest(int[][] edges, int numberOfVertices){
        super (edges, numberOfVertices);
    }

    /**that reads a graph from a file and determines whether the graph is connected**/
    //TODO: make not static
    public static boolean isGraphConnected(String fileName)  throws FileNotFoundException, NullPointerException, NumberFormatException {
        ...
        /**while there are lines in the input file**/
            ...
            try {
                ...
                /**for testing locally**/
                if ((fileIn = new File("src/cmsc256/" + fileName + ".txt")).exists()) {
                    fileIn = new File("src/cmsc256/" + fileName + ".txt");
                    isConnected = true;
                }
            }
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        System.out.println("Testing reading in of fileName: " + isGraphConnected(fileName));
        System.out.println("getPath: " + getPath(2, 1));
    }
}
