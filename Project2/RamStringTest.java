...
public class RamStringTest {
    ...
    @Test
    public void testGetEvenOrOddCharacters28() {
        RamString emptyString = new RamString("lalalalalalalala");
        String evenOrOdd = emptyString.getEvenOrOddCharacters("even");
        assertTrue("aaaaaaaa".equals(evenOrOdd));
    }

    @Test
    public void testGetEvenOrOddCharacters29() {
        RamString emptyString = new RamString("1'1 1e1t1r1p1t1s1m1 111i1s1i1 1h1s151r1n1,1r1g1t");
        String evenOrOdd = emptyString.getEvenOrOddCharacters("even");
        assertTrue("' etrptsm 1isi hs5rn,rgt".equals(evenOrOdd));
    }

    @Test
    public void testGetEvenOrOddCharacters30() {
        RamString emptyString = new RamString("c as");
        String evenOrOdd = emptyString.getEvenOrOddCharacters("even");
        assertTrue("c as".equals(evenOrOdd));
    }
    ...
    public void testCountDoubleDidgits3() {
        RamString rams1 = new RamString("1 23 456 7890 12345 678901");
        int result = rams1.countDoubleDigits();
        assertEquals(1, result);
    }
    @Test
    ...
    public void testConvertDigitsToRomanNumeralsInSubstring6(){
        RamString s = new RamString("1357");
        s.convertDigitsToRomanNumeralsInSubstring(1,4);
        System.out.print(s.getWackyString());
